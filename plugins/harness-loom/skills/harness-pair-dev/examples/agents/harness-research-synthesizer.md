...
description: "Use when the target's `/harness-orchestrate` dispatches the `harness-research-synthesizer` producer turn. Reads multiple sources and produces a structured synthesis memo."
skills:
